        ...
        <section class="section">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">@lang('langs.user_form')</h5>
                            ...
                            <form class="row g-3" action="{{route('user.store')}}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="mandali_code" value="{{old('mandali_code')}}"
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="mandali_name" value="{{old('mandali_name')}}"
                                ...
                                <div class="col-6">
                                    ...
                                    <textarea type="text" name="mandali_address"
                                              ...
                                              id="inputEmail4">{{old('mandali_address')}}</textarea>
                                ...
                                <div class="col-6">
                                    <label for="inputPassword4" class="form-label">@lang('langs.password')</label>
