                                    ...
                                    @foreach($customers as $customer)
                                        <tr>
                                            ...
                                            @if(isset($input['field']['user_id']))
                                                ...
                                                @else
                                                    <td class="ml-1 mr-1" style="padding: 7px;">{{ $customer->user->user_name}}</td>
                                                @endif
                                            @endif
                                            ...
                                            @if(isset($input['field']['bank_name']))
                                                @if(\Illuminate\Support\Facades\Auth::user()->lang == 'guj')
                                                    <td style="padding: 7px;">{{translateToGujarati($customer->bank_name)}} </td>
                                                @else
                                                    <td style="padding: 7px;">{{$customer->bank_name}} </td>
                                                @endif
                                            @endif
                                            @if(isset($input['field']['account_number']))
                                                @if(\Illuminate\Support\Facades\Auth::user()->lang == 'guj')
                                            ...
                                            @endif
                                            @if(isset($input['field']['ifsc_code']))
                                                <td style="padding: 7px;">{{$customer->ifsc_code}} </td>
                                            @endif
                                            @if(isset($input['field']['final_amount']))
                                            ...
                                            @if(isset($input['field']['insertedByUserId']))
                                                ...
                                                @else
                                                    <td style="padding: 7px;">{{$customer->created_bys->user_name}} </td>
                                                @endif
                                            @endif
                                            @if(isset($input['field']['created_at']))
                                                @if(\Illuminate\Support\Facades\Auth::user()->lang == 'guj')
                                                    <td style="padding: 7px;">{{gujarati_date($customer->created_at)}} </td>
                                                @else
                                                    <td style="padding: 7px;">{{formate_date($customer->created_at)}} </td>
                                                @endif
                                            @endif
                                        </tr>
                                    @endforeach
