                        ...
                        @foreach($customer_reports as $customer_report)
                            <tr style="text-align: center;">
                                ...
                                @if(isset($input['field']['user_id']))
                                    ...
                                    <td class="ml-1 mr-1" style="padding: 7px;">{{ translateToGujarati($customer_report->user->user_name)}}</td>
                                    @else
                                        <td class="ml-1 mr-1" style="padding: 7px;">{{ $customer_report->user->user_name}}</td>
                                    @endif
                                @endif
