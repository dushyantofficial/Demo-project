        ...
        <section class="section">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">@lang('langs.item_name_edit_form')</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{route('item_name.update',$item_names->id)}}" method="post"
                                  enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="col-12">
                                    <label for="inputNanme4" class="form-label">@lang('langs.item_name')</label>
                                    <input type="text" name="item_name" value="{{$item_names->item_name}}"
